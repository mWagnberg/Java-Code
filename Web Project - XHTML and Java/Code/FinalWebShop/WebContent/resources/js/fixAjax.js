/**
 * A fix to rendering issue for JSF f:ajax (and maybe p:ajax) tag that you have to click a button twice after another AJAX render (Known bug in JSF up to 2.2).
 * Got it from a post here: http://stackoverflow.com/questions/11408130/
 */
